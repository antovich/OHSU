...
MplusLocation <- 'H:/Projects/Y1-Y6 Comorbidity GMM for Sarah/Mplus Scripts/LCGA/LCGA Linear'
...
filename = "[[classes]]-class LGCA [[Measure#outcome]].inp";
...
i s ',ifelse(Quad, 'q', ''),' | [[Measure#outcome]]7@0 [[Measure#outcome]]8@1 [[Measure#outcome]]9@2 
[[Measure#outcome]]10@3 [[Measure#outcome]]11@4 [[Measure#outcome]]12@5 
[[Measure#outcome]]13@6 [[Measure#outcome]]14@7
...
SAVEDATA:
FILE IS "[[classes]]-class LGCA [[Measure#outcome]] Output.csv";
SAVE = CPROB;'
...
MplusData <- MplusOutput[[paste0("X",ModelNumber,".class.lgca.",tolower(Measure),".out")]]$savedata
