...
PSX_Mod <- '
#Indicators
  ParentReportSymptoms =~ Y1_P_C_ADHDRS_HYP_RS + Y1_KSAD_HYPSX + Y1_P_C_CON3_HYP_RS +
    Y1_P_SWAN_HYP + Y1_P_C_SDQ_HY_RS + Y1_P_C_ADHDRS_INT_RS + Y1_P_C_CON3_INT_RS + 
    Y1_P_SWAN_INT + Y1_KSAD_INTSX 
#Covariance
