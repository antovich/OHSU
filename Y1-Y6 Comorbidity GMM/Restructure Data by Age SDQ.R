...
AgeList = 7:19
YearList = 1:6
VarList = c("_DTEAM_MOOD", "_DTEAM_ANX", "_DTEAM_ODD", "_DTEAM_CD", "_P_SDQ_IM_TS")
row = 1 
...
#Sparsness and missingness by age
#######################################################################################
...
write.csv(DataByAge, "H:/Projects/Y1-Y6 Comorbidity GMM for Sarah/Data/Y1-Y6 enhanced Table 1 9-12-19_By_Age_With_SDQ.csv", row.names = FALSE)
