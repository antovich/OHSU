...
pal3 = c('#30B8DA','#FF6347','#2FCA72','#FFC34A')
...
FullData <- read_csv('H:/Projects/Y6 EATQ LPA for Sarah n400/Data/Y6 EATQ and Demo data 8-21-19.csv', na = c("", "NA", "-999"))
...
# # Reassign 4-class solution labels to align with 2-class after visual inspection, rename column heads for both class solutions
# if(NumClass == 4) {
#   ADHD_Classes4 <- mutate(ADHD_Classes, Class = recode(Class, "3" = 1, "4" = 2, "2" = 3, "1" = 4)) %>% #"Old" = New
#     rename("CPROB1" = CPROB3, "CPROB2" = CPROB4, "CPROB3" = CPROB2, "CPROB4" = CPROB1) %>% #"New" = Old 
