...
MplusLocation <- 'H:/Projects/Y1-Y6 Comorbidity GMM for Sarah/Mplus Scripts/RMLCA/RMLCA By Disorder'
...
outcome = 1:4;
Measure#outcome = ',paste0('ANX', AgeRange[1],'-ANX', last(AgeRange)),' ',paste0('CD', AgeRange[1],'-CD', last(AgeRange)),' ', 
paste0("MOOD", AgeRange[1],"-MOOD", last(AgeRange)), ' ',paste0("ODD", AgeRange[1],"-ODD", last(AgeRange)), ';

filename = "[[classes]]-class [[Measure#outcome]] RMCLA.inp";
